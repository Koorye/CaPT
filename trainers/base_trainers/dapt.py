...
def prototype_generator(cfg, clip_model):
    ...
    prototype_filepath = osp.join(cfg.DATASET.ROOT, DS_PATH[cfg.DATASET.NAME], 'split_fewshot', 'shot_' + str(cfg.DATASET.NUM_SHOTS) + '-seed_'+str(cfg.SEED) + '_prototype.pkl')
...
class DAPT(BaseTrainer):
    ...
    def model_inference(self, input):
        return super().model_inference(input)[0]
